...
// Estilos inline para substituir styled-components
    ...
    <div style={containerStyle}>
      ...
      <Card sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          ...
          <div ref={listContainerRef} style={{ flexGrow: 1, minHeight: 0, overflow: 'hidden' }}>
          ...
          <LoadingProgressModal
            open={Boolean(loadingProgress?.isActive && loadingProgress.phase !== 'cancelled') || loadingProgress?.phase === 'complete'}
            phase={loadingProgress?.phase || 'starting'}
            message={loadingProgress?.message || 'Carregando...'}
            ...
            jsonData={loadingProgress?.jsonData}
